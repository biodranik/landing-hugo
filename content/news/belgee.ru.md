...
[Игорь Давыдов]({{<relref "/team/Igor Davydov">}}) и [Сергей Васюкевич]({{<relref "/team/Siarhei Vasiukevich">}}) объясняют [принцип работы]({{<relref "/technology#как-работает-vibrobox">}}) VibroBox и просматривают автоматически созданный [отчёт]({{<demourl>}}) о состоянии оборудования и подробные рекомендации по его обслуживанию.
{{% /figure %}}
