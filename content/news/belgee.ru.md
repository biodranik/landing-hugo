...
[Игорь Давыдов]({{<relref "Igor Davydov">}}) и [Сергей Васюкевич]({{<relref "Sergey Vasukevich">}}) объясняют [принцип работы]({{<relref "technology#как-работает-vibrobox">}}) VibroBox и просматривают автоматически созданный [отчёт]({{<demourl>}}) о состоянии оборудования и подробные рекомендации по его обслуживанию.
{{% /figure %}}
